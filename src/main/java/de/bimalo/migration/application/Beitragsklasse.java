...
public enum Beitragsklasse {
  ...
  JUDO_AUFNAHMEGEBUEHR("Judo Aufnahmegebühr", "", false),
  ...
  SCHACH_ABTEILUNG_BEITRAGSFREI(
      "Schach abteilungsbeitragsfrei", "Schach - Beitragsfrei - aktiv", true),
  ...
  TT_ABTEILUNG_BEITRAGSFREI(
      "TT abteilungsbeitragsfrei", "Tischtennis - Beitragsfrei - aktiv", true),
  TT_ANTEILIG("TT anteilig", "", false),
  TT_JUGEND("TT Jugendliche", "Tischtennis - Jugend", true),

  FB_ERHOBEN("FB erhoben", "", false),

  BREITENSPORT_ABTEILUNG_BEITRAGSFREI(
      "Breitensport abtl.beitragsfrei", "Breitensport - Beitragsfrei - aktiv", true),
  ...
  LA_KINDER2("LA  Kinder", "Breitensport - Kinder", true),
  ...
  HANDBALL_ABTEILUNG_BEITRAGSFREI(
      "Handball abtl.beitragsfrei", "Handball - Beitragsfrei - aktiv", true),
  ...
  VOLLEYBALL_ABTEILUNG_BEITRAGSFREI(
      "Volleyball abtl.beitragsfrei", "Volleyball - Beitragsfrei - aktiv", true),
  ...
  KEGELN_ABTEILUNG_BEITRAGSFREI(
      "Kegeln abteilungsbeitragsfrei", "Kegeln - Beitragsfrei - aktiv", true),
  ...
  @Getter private String elvisBeitrag;
